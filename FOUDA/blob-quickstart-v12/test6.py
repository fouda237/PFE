...
def run_example(config):
    ...
    credentials = ClientSecretCredential(
        client_id = config['e97e04b4-1367-4c10-9c30-415c956cc39e'],
        client_secret = config['267f637f-c067-4484-b2af-730f2756ddb5'],
        tenant_id = config['1b3dde29-70fd-4cc6-8b7b-535c5ec4a644'],
...
if __name__ == "__main__":
    with open('C:/Users/fouda/OneDrive/Bureau/FOUDA/blob-quickstart-v12/sample.json', 'r') as f:
        config = json.load(f)
    run_example(config)