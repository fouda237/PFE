...
orl=r'C:\Users\fouda\OneDrive\Bureau\yandex\hada.png'
...
for i in range(0,1):
        ...
        for i in range(10):
              ...
              # print(b)
              orli="C:/Users/fouda/OneDrive/Bureau/yandex/hadam/"+b+".png"
              shutil.copyfile(orl, orli)
              l="https://"+bucket_name+".s3."+location+".amazonaws.com/"+b+".png"
