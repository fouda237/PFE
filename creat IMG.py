...
##### numbre suffix
        for b in range(0,10) :
                    file_path=r'C:\Users\Administrator\Desktop\api google cloud\filles'
                    filename=get_random_string_lowercas(random.randint(30,40))
                    upload_blob(bucket_name,os.path.join(file_path,'primade1.jpg'),filename)
